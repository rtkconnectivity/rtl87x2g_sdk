...
#define GAP_MSG_VENDOR_EVT_INFO         0x16 //!< Vendor-specific events.

#define GAP_MSG_GAP_READ_AFH_CHANNEL_ASSESSMENT_MODE           0x17
#define GAP_MSG_GAP_WRITE_AFH_CHANNEL_ASSESSMENT_MODE          0x18
...
typedef struct
{
    ...
    uint8_t                 afh_channel_assessment_mode; /**< Controller's channel assessment scheme.
                                                              @arg 0x00: Controller channel assessment disabled.
                                                              @arg 0x01: Controller channel assessment enabled. */
 ...
 *         registered by @ref gap_register_app_cb with cb_type @ref GAP_MSG_GAP_READ_AFH_CHANNEL_ASSESSMENT_MODE.
 *
 ...
 *
 * @return The result of sending read request.
 * @retval GAP_CAUSE_SUCCESS Sending read request operation is successful.
 * @retval Others Sending read request operation is failed.
 *
 * <b>Example usage</b>
 * \code{.c}
    void test(void)
 ...
 *         registered by @ref gap_register_app_cb with cb_type @ref GAP_MSG_GAP_WRITE_AFH_CHANNEL_ASSESSMENT_MODE.
 *
 * Applications can only call this API after Bluetooth Host is ready. \n
 *                Explanation: If Bluetooth Host is ready, the application will be notified by message @ref GAP_MSG_LE_DEV_STATE_CHANGE
 *                             with new_state about gap_init_state which is configured as @ref GAP_INIT_STATE_STACK_READY.
 ...
 *                                         @arg 0x01: Controller channel assessment enabled.
 *
 * @return The result of sending write request.
 * @retval GAP_CAUSE_SUCCESS Sending write request operation is successful.
 * @retval Others Sending write request operation is failed.
 *
 * <b>Example usage</b>
 * \code{.c}
    void test(void)
