                          ...
                          size_t ilen)
{
    ...
    if (ctx->is224 == 0)
    {
        if (hw_sha2_cpu_update((void *)ctx, (uint8_t *)input, ilen) == false)
        {
                          ...
                          unsigned char *output)
{
    ...
    if (ctx->is224 == 0)
    {
        if (hw_sha2_finish((void *)ctx, (uint32_t *)output) == false)
        {
            // return non-zero to indicate error
            return 1;
        }
