...
/**
  ...
  * @retval 1 true
  */
bool bt_matter_adapter_service_set_parameter(T_BTCONFIG_PARAM_TYPE param_type,
                                             uint16_t len,
                                             void *p_value)
{
    bool ret = false;
...
*/
T_APP_RESULT bt_matter_adapter_service_attr_read_cb(uint8_t conn_id,
 ...
 * @return Profile procedure result
*/
T_APP_RESULT bt_matter_adapter_service_attr_write_cb(uint8_t conn_id,
                                                     T_SERVER_ID service_id,
                                                     uint16_t attrib_index,
 ...
 * @return None
*/
void bt_matter_adapter_service_cccd_update_cb(uint8_t conn_id,
                                              T_SERVER_ID service_id,
                                              uint16_t index,
                                              uint16_t cccbits)
{
...
bool bt_matter_adapter_indication_send(uint8_t conn_id, uint8_t *p_data, uint16_t data_len)
{
    return server_send_data(conn_id,
                            bt_matter_adapter_service_id,
                            BT_MATTER_ADAPTER_SERVICE_CHAR_INDICATE_CCCD_INDEX - 1,
                            p_data,
                            data_len,
