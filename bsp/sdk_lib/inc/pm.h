...
typedef enum
{
    BTPOWER_DEEP_SLEEP        = 0,   /**< BT sleep mode */
...
//    POWER_POWEROFF_MODE    = 0,
    ...
    POWER_DLPS_MODE        = 2,   /**< DLPS mode, deep low power sleep state.  */
...
typedef enum
{
    PM_WAKEUP_UNKNOWN              = 0x00000000,  /**< Unknown wake up            */
    PM_WAKEUP_PRE_SYSTEM_LEVEL     = 0x00000001,  /**< Other power module wake up */
    PM_WAKEUP_PF_RTC               = 0x00000100,  /**< Platform RTC wake up       */
    PM_WAKEUP_RTC                  = 0x00000200,  /**< User RTC wake up           */
    PM_WAKEUP_MAC                  = 0x00000400,  /**< MAC wake up                */
    PM_WAKEUP_GPIO                 = 0x00000800,  /**< GPIO wake up               */
    PM_WAKEUP_REASON_USB           = 0x00001000,  /**< USB wake up                */
    PM_WAKEUP_REASON_LPCOMP        = 0x00002000,  /**< LPC wake up                */
    PM_WAKEUP_REASON_AON_QUAD_DEC  = 0x00004000,  /**< AON QDecoder wake up       */
...
typedef enum
{
    ...
    PM_ERROR_DISABLE_DLPS_TIME     = 0x2,   /**< Vendor allow sleep time is not timeout.  */
    ...
    PM_ERROR_ERROR_OCCUPIED_TIME   = 0x9,   /**< Power manager request occupied source.   */
} PowerModeErrorCode;
...
/** @brief This callback function is used for any module which needs to be executed before entering or after exiting from DLPS. */
 ...
 * @param        mode Platform power mode, @ref T_SYSTEM_POWER_MODE.
 ...
 * @param  mode DLPS sub mode, @ref POWERDlpsMode.
 * @return Operation result.
 * @retval 0     Success
 * @retval Others Fail
 * @note   Switch DLPS mode between @ref POWER_DLPS_PFM_MODE and @ref POWER_DLPS_RET_MODE.
*/
 ...
 * @param  mode BT power mode, @ref T_BT_POWER_MODE.
*/
 ...
 * @param  func  Check callback function, @ref POWERCheckFunc.
 * @return Operation result.
 * @retval 0     Success
 * @retval Others Fail
*/
 ...
 * @param  func  Callback function, @ref POWERStageFunc.
 * @param  stage Power stage for the callback function, @ref POWERStage.
 * @return Operation result.
 * @retval 0     Success
 * @retval Others Fail
*/
 ...
 * @param  last_wakeup_clk: Last wake-up clock, unit: 31.25us.
 ...
 * @param  handle: Handle of SW timer or task.
 * @param  type: Type of SW timer or task, @ref PowerModeExcludedHandleType.
 ...
 * @param  handle: Handle of timer or task.
 * @param  type: Type of timer or task, @ref PowerModeExcludedHandleType.
 * @return Operation status
*/
